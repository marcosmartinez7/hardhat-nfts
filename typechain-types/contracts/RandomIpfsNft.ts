...
export interface RandomIpfsNFTInterface extends utils.Interface {
  functions: {
    ...
    "getCharacterByModdedRng(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCharacterByModdedRng",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
...
export interface RandomIpfsNFT extends BaseContract {
  ...
  callStatic: {
    ...
    requestNft(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  filters: {
    ...
    NftMinted(char?: null, requested?: null): NftMintedEventFilter;
